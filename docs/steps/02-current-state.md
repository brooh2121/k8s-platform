...
На текущий момент в проекте выполнены базовые шаги подготовки кластера Kubernetes, установка `ArgoCD` и Ingress, первичная настройка GitOps, а также черновик IaC на OpenTofu и Terraform.
